...
tf.app.flags.DEFINE_string("learning_rate", 0.01,
                           "Learning rate")
...
def main(_):
  ...
  if FLAGS.job_name == "ps":
    sess = tf.Session(server.target, checkpoint_dir=FLAGS.train_dir)
    ...
    with sv.managed_session(server.target, checkpoint_dir=FLAGS.train_dir) as sess:
